...
$(document).ready(function () {
    ...
    function recalcElement(obj) {
        ...
        obj.parents('.buyblock').find('.jsPrice').html(value2 + ' р.');
        if (quantity < 2) {
...
$(document).ready(function () {
    ...
    if (getCookie("grafikRaboty") !== "wasShown" && $.inArray((new Date()).getDate(), [/* 27,28, 09, 30,31,1,2,3,4,5,6,7 */]) >= 0)
    {
        var grafikRaboty = new BX.PopupWindow(
                ...
                null,
                {
                    content: "<div id='grafikRaboty'><b><center>График работы на праздничные дни:</center></b><br><b>31.12.16</b> наш онлайн-магазин работает до 14:00 <br><b>01.01.17</b> - выходной<br>В остальные дни принимаем заказы в обычном режиме</div>",
                    autoHide: false,
                    offsetLeft: 0,
                    offsetTop: 0,
                    overlay: true,
...
{
    $.ajax({
        url: '/bitrix/templates/foodbox_new/components/bitrix/sale.order.ajax/monopoly_new/script.js',
        type: "GET",
        dataType: "script"
    });
