$(document).ready(function () {
    ...
    $("#sendquest").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/bitrix/templates/mshop_default/include/question.php",
            data: {quest: ques,
    ...
    $("#getpassauth").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/bitrix/templates/mshop_default/include/getpassauth.php",
            data: {
...
//Подтвердить код
    ...
    $("#setEmail").click(function () {
        $.ajax({
            type: 'POST',
            url: "/bitrix/templates/mshop_default/include/emailset.php",
            data: {
    ...
    $(document).ready(function () {
        ...
        $('#but_reg').click(function () {
            $.ajax({
                type: 'POST',
                url: "/bitrix/templates/mshop_default/include/getphone.php",
                data: {
