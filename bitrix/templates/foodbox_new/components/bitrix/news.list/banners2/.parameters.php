...
$arTemplateParameters = array(
    ...
    'RSMONOPOLY_SIDEBAR_IBLOCK_TYPE' => array(
        'NAME' => GetMessage('RSMONOPOLY_SIDEBAR_IBLOCK_TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => $arIBlockTypes,     
        'REFRESH' => 'Y'
    ),
    'RSMONOPOLY_SIDEBAR_IBLOCK_ID' => array(
        'NAME' => GetMessage('RSMONOPOLY_SIDEBAR_IBLOCK_ID'),
        'TYPE' => 'LIST',
        'VALUES' => $arIBlock
    ),
