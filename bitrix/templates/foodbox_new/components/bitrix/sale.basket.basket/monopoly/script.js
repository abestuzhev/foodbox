...
function couponCreate(couponBlock, oneCoupon)
{
	...
	couponBlock.appendChild(BX.create(
		...
		{
			props: {
				className: 'form-group has-feedback ' + couponClass
			},
			children: [
				BX.create(
					'label',
					{
						...
						html: $('#coupons_block').data('msgcounpon')
					}
				),
				BX.create(
					'input',
						...
						children: [
							...
							BX.create(
								'span',
								{
									...
									html: $('#coupons_block').data('msgdelete')
								}
							)
						]
					}
			...
			if (!!couponsCollection)
			{
				...
				for (i = 0; i < res.COUPON_LIST.length; i++)
				{
					...
					if (couponFound)
					{
						...
						BX.adjust(couponsCollection[key].parentNode, {props: {className: 'form-group has-feedback ' + couponClass}});
						//BX.adjust(couponsCollection[key].nextSibling, {props: {className: couponClass}});
						BX.adjust(couponsCollection[key].nextSibling.nextSibling.firstChild, {html: res.COUPON_LIST[i].JS_CHECK_CODE+'&nbsp;'});
					}
					else
					{
...
{
	BX.removeClass(BX("basket_toolbar_button"), "current btn-primary");
	BX.removeClass(BX("basket_toolbar_button_delayed"), "current btn-primary");
	BX.removeClass(BX("basket_toolbar_button_subscribed"), "current btn-primary");
	BX.removeClass(BX("basket_toolbar_button_not_available"), "current btn-primary");

	//BX.removeClass(BX("basket_toolbar_button"), "btn-primary");
	...
	if (val == 2)
	{
		...
		if (BX("basket_items_delayed"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_delayed"), "current btn-primary");
	...
	else if(val == 3)
	{
		...
		if (BX("basket_items_subscribed"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_subscribed"), "current btn-primary");
	...
	else if (val == 4)
	{
		...
		if (BX("basket_items_not_available"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_not_available"), "current btn-primary");
	...
	else
	{
		if (BX("basket_items_list"))
		{
			...
			BX.addClass(BX("basket_toolbar_button"), "current btn-primary");
