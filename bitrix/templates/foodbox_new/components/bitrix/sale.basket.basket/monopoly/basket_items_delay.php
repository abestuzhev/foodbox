...
<table class="sale_basket_basket data-table table table-striped">
	<tr>
		...
		<tr>
			<?if (in_array("NAME", $arParams["COLUMNS_LIST"])):?>
				...
				if (strlen($arBasketItems["DETAIL_PAGE_URL"])>0):
					?><a class="aprimary" href="<?echo $arBasketItems["DETAIL_PAGE_URL"] ?>"><?
				endif;
			...
			<?endif;?>
			<?if (in_array("PRICE", $arParams["COLUMNS_LIST"])):?>
				<td align="right"><span class="price text-nowrap"><?=$arBasketItems["PRICE_FORMATED"]?><span></td>
			<?endif;?>
			<?if (in_array("TYPE", $arParams["COLUMNS_LIST"])):?>
...
<br />
<div width="30%">
	<input class="btn btn-default" type="submit" value="<?= GetMessage("SALE_REFRESH")?>" name="BasketRefresh"><br />
