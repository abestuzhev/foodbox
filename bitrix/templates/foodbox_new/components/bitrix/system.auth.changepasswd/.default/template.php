...
?><form class="form-horizontal" method="post" action="<?=$arResult['AUTH_FORM']?>" name="bform"><?
	...
	?><div class="form-group"><?
		?><label for="USER_CHECKWORD" class="col-sm-2 control-label"><?=GetMessage('AUTH_CHECKWORD')?></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_PASSWORD" class="col-sm-2 control-label"><?=GetMessage('AUTH_NEW_PASSWORD_REQ')?></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_CONFIRM_PASSWORD" class="col-sm-2 control-label"><?=GetMessage('AUTH_NEW_PASSWORD_CONFIRM')?></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><div class="col-sm-offset-2 col-sm-10"><?
			...
			?><a class="aprimary" href="<?=$arResult['AUTH_AUTH_URL']?>"><?=GetMessage('AUTH_AUTH')?></a><?
		?></div><?
	?></div><?
