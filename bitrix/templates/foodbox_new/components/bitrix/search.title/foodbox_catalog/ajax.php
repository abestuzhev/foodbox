...
if (empty($arResult["CATEGORIES"]))
    return;
?>
<div class="bx_searche bx_searche_catalog">
                        ...
                        <noindex>
                            <div class="buybtn">
                                <form class="add2basketform js-buyform<?= $arElement["ID"] ?>" name="add2basketform">
                                    ...
                                    <button type="submit" rel="nofollow" class="submit js-add2basketlink" value=""></button>
                                    <a class="inbasket" href="/personal/cart/"></a>
                                </form>
                            </div>
                        </noindex>
                        <?
