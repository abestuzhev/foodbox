...
?><form class="form-horizontal" method="post" action="<?=$arResult['AUTH_URL']?>" name="bform"><?
	...
	?><div class="form-group"><?
		?><label for="USER_NAME" class="col-sm-2 control-label"><?=GetMessage("AUTH_NAME")?></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_LAST_NAME" class="col-sm-2 control-label"><?=GetMessage("AUTH_LAST_NAME")?></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_LOGIN" class="col-sm-2 control-label"><?=GetMessage("AUTH_LOGIN_MIN")?> <span class="starrequired">*</span></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_PASSWORD" class="col-sm-2 control-label"><?=GetMessage("AUTH_PASSWORD_REQ")?> <span class="starrequired">*</span></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_CONFIRM_PASSWORD" class="col-sm-2 control-label"><?=GetMessage("AUTH_CONFIRM")?> <span class="starrequired">*</span></label><?
		?><div class="col-sm-10"><?
	...
	?><div class="form-group"><?
		?><label for="USER_EMAIL" class="col-sm-2 control-label"><?=GetMessage('AUTH_EMAIL')?><?if($arResult['EMAIL_REQUIRED']):?> <span class="starrequired">*</span><?endif;?></label><?
		?><div class="col-sm-10"><?
	...
	if($arResult['USER_PROPERTIES']['SHOW'] == 'Y') {
		foreach($arResult['USER_PROPERTIES']['DATA'] as $FIELD_NAME => $arUserField) {
			?><div class="form-group"><?
				?><label for="field_<?=$FIELD_NAME?>" class="col-sm-2 control-label"><?=GetMessage('AUTH_EMAIL')?><?if($arResult['EMAIL_REQUIRED']):?>*<?endif;?></label><?
				?><div class="col-sm-10"><?
	...
	if($arResult['USE_CAPTCHA']=='Y') {
		?><div class="form-group"><?
			?><div class="col-sm-offset-2 col-sm-10"><?
				...
				?><input class="form-control" type="text" name="captcha_word" maxlength="50" value="" placeholder="<?=GetMessage('CAPTCHA_REGF_PROMT')?>*" /><?
			?></div><?
		?></div><?
	}
	// /CAPTCHA
	...
	?><div class="form-group"><?
		?><div class="col-sm-offset-2 col-sm-10"><?
			...
			?><div><span class="starrequired">*</span> <?=GetMessage('AUTH_REQ')?></div><?
			?><div><a class="aprimary" href="<?=$arResult['AUTH_AUTH_URL']?>" rel="nofollow"><?=GetMessage('AUTH_AUTH')?></a></div><?
		?></div><?
	?></div><?
