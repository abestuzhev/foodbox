...
<?endif?>
<table class="table table-stripped sale_personal_profile_list data-table">
	<tr>
		<th><?=GetMessage("P_ID")?></th>
		<th><?=GetMessage("P_DATE_UPDATE")?></th>
		<th><?=GetMessage("P_NAME")?></th>
	...
	<?foreach($arResult["PROFILES"] as $val):?>
		<tr>
			...
			<td><a class="aprimary" title="<?= GetMessage("SALE_DETAIL_DESCR") ?>" href="<?=$val["URL_TO_DETAIL"]?>"><?= GetMessage("SALE_DETAIL") ?></a><br />
