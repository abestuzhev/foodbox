<?
/* Вот тут находятся 3  заголовка блоков на главной */
$MESS["arrFilterFIRSTBLOCK"] = "РЕКОМЕНДУЕМ КУПИТЬ";
$MESS["arrFilterSECONDBLOCK"] = "АКЦИИ И СКИДКИ";
$MESS["arrFilterTHIRDBLOCK"] = "НОВИНКИ АССОРТИМЕНТА";
/*КОНЕЦ */

$MESS["CT_BCT_ELEMENT_DELETE_CONFIRM"] = "Будет удалена вся информация, связанная с этой записью. Продолжить?";
$MESS["CT_BCT_TPL_MESS_BTN_ADD_TO_BASKET"] = "Купить";
