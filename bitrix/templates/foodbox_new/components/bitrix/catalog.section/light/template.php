...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	?><div class="owlslider products products-owl-slider showcase"><?
		...
		foreach($arResult['ITEMS'] as $arItem) {
			...
			if(empty($arItem['OFFERS'])){ 
                ...
                foreach($arItem['OFFERS'] as $arOffer) {
                    ...
                    foreach($skuProperties as $sPropertyName => $sPropertyValue) {
                        
                        if(empty($arOffer['PROPERTIES'][$sPropertyName]['VALUE'])) {
                            continue;
                        }
                        
                        if($sPropertyValue == $arOffer['PROPERTIES'][$sPropertyName]['VALUE']) {
                            $matches++;
                        }
                    }
                ...
                //echo '<pre>';
                    //var_dump($selectedOffer['PROPERTIES']['MATERIAL']);
                //echo '</pre>';
                
            }
			?><div class = "item js-element js-elementid<?=$arItem['ID']?>" 
