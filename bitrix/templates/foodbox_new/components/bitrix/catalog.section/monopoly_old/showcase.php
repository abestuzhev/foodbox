	...
	?><div class="row products <?=$arResult['TEMPLATE_DEFAULT']['CSS']?>"><?
		foreach($arResult['ITEMS'] as $key1 => $arItem) {
			...
			?><div class="item <?
				...
				?>col <?if($arParams["RS_IS_2_COL"]=='Y'):?>col-sm-6<?else:?>col-xs-6 item_one_column<?endif;?> col-md-<?if($arParams["SIDEBAR"]=='Y'):?>6<?else:?>4<?endif;?> col-lg-<?if($arParams["SIDEBAR"]=='Y'):?>4<?else:?>3<?endif;?> <?
