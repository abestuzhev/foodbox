		...
		window['trackBar<?=$key?>'] = new BX.Iblock.SmartFilter(<?=CUtil::PhpToJSObject($arJsParams)?>);
						...
						?><div class="body bx_filter_parameters_box bx_filter_block clearfix"><?
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "G"://CHECKBOXES_WITH_PICTURES
									?>
									<span class="bx_filter_container_modef_cansel"></span>
									<?foreach ($arItem["VALUES"] as $val => $ar):?>
										...
										<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="cwp bx_filter_param_label dib<?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');">
											...
											<span class="bx_filter_param_btn bx_color_sl">
												...
												<span class="bx_filter_btn_color_icon" style="background-image:url('<?=$ar["FILE"]["SRC"]?>');"><span class="bx_filter_container_modef"></span></span>
												<?endif?>
											</span>
										</label>
									<?endforeach?>
								...
								case "H"://CHECKBOXES_WITH_PICTURES_AND_LABELS
									...
									<?foreach ($arItem["VALUES"] as $val => $ar):?>
										...
										if ($ar["DISABLED"])
											$class.= " disabled";
										?>
										<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label_color cwpal bx_filter_param_label<?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');">
											...
											<span class="bx_filter_param_text bx_filter_param_text_color" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
											if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
												?> <span class="role_count">(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)</span><?
											endif;?><span class="bx_filter_container_modef"></span></span>
										</label>
									<?endforeach?>
									<?
									break;
								...
								case "K"://RADIO_BUTTONS
									...
									<label class="rb bx_filter_param_label" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
										...
										<span class="bx_filter_input_checkbox">
											...
											/>
											<span class="bx_filter_param_text"><? echo GetMessage("CT_BCSF_FILTER_ALL"); ?><span class="bx_filter_container_modef"></span></span>
										</span>
									</label>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
			...
			?><li class="<?if($arParams['RS_FILTER_TYPE']=='ftype2'):?> col col-xs-12<?endif;?>"><?
				?><div class="buttons text-center bx_filter_prop"><?
					...
					?></a><?
					?><a class="btn btn-default bx_filter_search_reset" id="del_filter" /><?=GetMessage("CT_BCSF_DEL_FILTER")?></a>&nbsp;<?
