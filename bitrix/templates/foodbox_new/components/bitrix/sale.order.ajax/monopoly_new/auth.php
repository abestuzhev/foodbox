...
function getAuthForm($arResult) 
{
	...
	?>
		<form method = "POST" action = "" name = "order_auth_form">
			...
			<div class="form-group">
				<input class = "btn btn-primary" type="submit" value="<?=Loc::getMessage("STOF_NEXT_STEP")?>">
		...
		<form method="post" action="" name="order_reg_form">
			...
			<?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
				<div class = "radio">
					...
					<label for="NEW_GENERATE_N"><?=Loc::getMessage("STOF_MY_PASSWORD")?></label>
				</div>
            <? endif; ?>
            <? if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"): ?>
            ...
            <? if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"): ?>
				<div class = "radio">
					...
					<label for="NEW_GENERATE_Y"><?=Loc::getMessage("STOF_SYS_PASSWORD")?></label>
				</div>
				<script>
					<!--
