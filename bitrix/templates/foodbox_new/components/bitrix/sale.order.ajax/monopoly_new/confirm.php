    ...
    <div class="row">
        <div class="col col-md-12">
            ...
            <? if (!empty($arResult['PAY_SYSTEM'])): ?>
                ...
                <? if (!empty($arResult["PAY_SYSTEM"]["ACTION_FILE"])): ?>
                    <? if ($arResult["PAY_SYSTEM"]["NEW_WINDOW"] == "Y"): ?>
                        <script>
                            window.location.assign('<?= $arParams["PATH_TO_PAYMENT"] ?>?ORDER_ID=<?= urlencode(urlencode($arResult["ORDER"]["ACCOUNT_NUMBER"])) ?>', '_blank');
                        </script>
                        <p>
                        ...
                        <? ?>
                    <? elseif (!empty($arResult["PAY_SYSTEM"]["PATH_TO_ACTION"])): ?>
