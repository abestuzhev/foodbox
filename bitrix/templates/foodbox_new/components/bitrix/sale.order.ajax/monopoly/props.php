	...
	?>
		<div class = "col col-md-6">		
			<div class="form-group">
				<label for="ID_PROFILE_ID"><?=Loc::getMessage("SOA_TEMPL_PROP_CHOOSE")?></label>
				<select name="PROFILE_ID" class="form-control" id="ID_PROFILE_ID" onChange="SetContact(this.value)">
...
<div class = "col col-md-12">
	...
	<?
		...
		//PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], $i);
	?>
</div>
