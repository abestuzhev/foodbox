				...
				<div>
					...
					foreach ($arSource as $arProperties)
					{
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<div class="checkbox">
										...
										<label for="<?=$arProperties["FIELD_NAME"]?>">&nbsp;<?=$arProperties["NAME"]?><?if ($arProperties["REQUIED_FORMATED"]=="Y"):?><span class="bx_sof_req">*</span><?endif;?></label>
									</div>
									<?if (strlen(trim($arProperties["DESCRIPTION"])) > 0):?>
										<p class="help-block"><?=$arProperties["DESCRIPTION"]?></p>
									<?endif;?>
								</div>
							</div>
							<?
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							?>
							<div class="form-group">
								<label for="<?=$arProperties["FIELD_NAME"]?>" class="col-sm-2 control-label text-nowrap"><?=$arProperties["NAME"]?> <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?><span class="bx_sof_req">*</span><?endif;?></label>
								<div class="col-sm-10">
						...
						elseif ($arProperties["TYPE"] == "FILE")
						{
							?>
							<div class="form-group">
								<label for="ORDER_PROP_<?=$arProperties["ID"]?>" class="col-sm-2 control-label text-nowrap"><?=$arProperties["NAME"]?> <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?><span class="bx_sof_req">*</span><?endif;?></label>
								<div class="col-sm-10">
