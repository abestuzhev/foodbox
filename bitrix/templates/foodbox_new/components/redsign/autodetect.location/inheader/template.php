...
?><span class="locationinhead hidden-xs"><?
        ...
        ?><span class="dropdown"><?
            ...
            if(is_array($arResult["LOCATIONS"]) && count($arResult["LOCATIONS"])>0) {
                ?><ul class="dropdown-menu list-unstyled" aria-labelledby="ddLocationMenu"><?
                    ...
                    ?><li><a class="fancyajax fancybox.ajax big" href="<?=SITE_DIR?>cities/" title="<?=GetMessage('RS.MONOPOLY.YOUR_CITY')?>"><?=GetMessage('RS.MONOPOLY.ALL_CITIES')?></a></li><?
                ?></ul><?
            }
        ?></span><?
		$frame->beginStub();
